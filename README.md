...
| 資料 | 內容 | 審核 |
| --- | --- | --- |
| 健保支付標準 | 全部檢驗支付項目，每筆附實驗室 scope 判定 | 專案負責人審核；scope 由 AI 審核（[紀錄](docs/reviews/nhi-lab-scope-ai-review-2026-09-14.md)） |
| 食藥署醫療器材許可證 | 10 萬多筆全收錄，每筆標出是否屬體外診斷 | AI 代審（[紀錄](docs/reviews/tfda-ivd-ai-review-2026-09-14.md)） |
