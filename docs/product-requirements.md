...
| OD-04 | CDC 採檢手冊內容與認可檢驗機構名單由 AI 全程代審；正式結果不加「未經人工複核」備註（owner 2026-09-15 回答：「Ai全程代審 不用特別備注未經人工審核」） | review record 的 reviewer 必須標明為 AI，不得寫成人工或「專案負責人」；新版處理時間（turnaround）尚未決定；實作前另立 CDC review protocol |
