...
6. 「糞便檢體怎麼採？」「什麼樣的檢體會被判定不良？」：應該列出第 3–6 章對應的條文，帶條號與頁碼（例如 4.6 不良檢體判定標準）。
...
- 疾管署採檢手冊收錄第 2 章「傳染病檢體採檢及運送規定總覽表」、第 3–6 章（採檢步驟、包裝運送、外溢清消、運送箱清消）與第 7 章「傳染病檢體送驗地點及檢驗期間一覽表」（含 7.9 收件單位聯絡方式）。1150826 版為第 2 章 370 列、第 3–6 章 143 條（含圖說）、第 7 章 218 列、收件單位 4 筆。第 8 章以後的地理位置圖與附件沒有收錄。
