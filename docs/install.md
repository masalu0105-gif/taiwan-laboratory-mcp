...
- 疾管署採檢手冊整本收錄：第 1 章通則、第 2 章「傳染病檢體採檢及運送規定總覽表」、第 3–6 章（採檢步驟、包裝運送、外溢清消、運送箱清消）、第 7 章「傳染病檢體送驗地點及檢驗期間一覽表」（含 7.9 收件單位聯絡方式）、第 8 章地理位置、第 9 章屍體解剖與附件一～七表單。1150826 版為第 2 章 370 列、第 7 章 218 列、收件單位 4 筆、其餘文字內容 177 條（含各章圖說與附件）。手冊裡的圖片本身沒有收錄，只有圖說文字。
...
- 2026-09-22 已在 Grok Bot VM 架設公開正式端點：`https://lab.masalulab.com/mcp`。Windows 外部 MCP client 已驗證 24 個工具、四個可用且可追溯來源，以及 NHI／TFDA／CDC 實際查詢。
