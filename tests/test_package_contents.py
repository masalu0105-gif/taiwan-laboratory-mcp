...
REQUIRED_FILES = {
    ...
    "taiwan_lab_mcp/review_protocols/cdc-labs-r1-ai-review/2.json",
    "taiwan_lab_mcp/review_protocols/cdc-labs-r1-auto-review/1.json",
    "taiwan_lab_mcp/review_protocols/cdc-labs-r1-auto-review/2.json",
    "taiwan_lab_mcp/review_protocols/cdc-manual-r1-ai-review/1.json",
    "taiwan_lab_mcp/review_protocols/cdc-manual-r1-ai-review/2.json",
    "taiwan_lab_mcp/review_protocols/cdc-manual-r1-ai-review/3.json",
    "taiwan_lab_mcp/review_protocols/cdc-manual-r1-ai-review/4.json",
    "taiwan_lab_mcp/review_protocols/cdc-manual-r1-ai-review/5.json",
    "taiwan_lab_mcp/review_protocols/cdc-manual-r1-auto-review/1.json",
    "taiwan_lab_mcp/review_protocols/cdc-manual-r1-auto-review/2.json",
    "taiwan_lab_mcp/review_protocols/cdc-manual-r1-auto-review/3.json",
    "taiwan_lab_mcp/review_protocols/cdc-manual-r1-auto-review/4.json",
    "taiwan_lab_mcp/review_protocols/cdc-manual-r1-auto-review/5.json",
